...
public class StashFinder extends Module {
    ...
    private final Setting<List<Block>> regularBlocks = sgGeneral.add(new BlockListSetting.Builder()
        .name("regular-blocks")
        .description("Select the regular blocks to search for.")
        .build()
    );
    ...
    private void onChunkData(ChunkDataEvent event) {
                ...
                for (int x = 0; x < 15; x++) {
                    for (int y = 0; y < 15; y++) {
                        for (int z = 0; z < 15; z++) {
                            ...
                            if (regularBlocks.get().contains(block)) chunk.regular++;
                        }
                    }
                }
            }
        ...
        if (chunk.getTotal() + solid >= minimumStorageCount.get()) {
    ...
    public static class Chunk {
        ...
        public int chests, barrels, shulkers, enderChests, furnaces, dispensersDroppers, hoppers, regular;
        ...
        public int getTotal() {
            return chests + barrels + shulkers + enderChests + furnaces + dispensersDroppers + hoppers + regular;
        }
